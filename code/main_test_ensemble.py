...
# abide
# version = 'v0_transform_biopoint_nopretrain'
# parser.add_argument('--version', default=f'abide.{version}', type=str)
# parser.add_argument('--checkpoint_path',
#                     default=f'/home/yz2337/project/multi_fmri/runs/{version}/model.pt', type=str)
# parser.add_argument(
#     '--save_dir', default=f'/home/yz2337/project/multi_fmri/results/{version}', type=str)
