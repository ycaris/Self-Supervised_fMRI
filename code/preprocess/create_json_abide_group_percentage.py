...
training_percentages = [5, 10, 20, 40, 60, 80, 100]
...
def create_pretrain(train_df, val_df):
    dataset_splits = {
...
def generate_and_save_splits(train_df, fold_idx, percentage, validation_set, testing_set):
    ...
    with open(f'/home/yz2337/project/multi_fmri/code/json_files/abide_percent/{percentage}/fold_{fold_idx}.json', 'w') as f:
