...
def split_data(data_folder, train_pct=0.9, val_pct=0.1, test_pct=0.0):
    ...
    with open('/home/yz2337/project/multi_fmri/code/json_files/pretrained/abide.json', 'w') as f:
        json.dump(splits, f, indent=4)


# Set your data folder path
data_folder = '/home/yz2337/project/multi_fmri/data/ABIDE/numpy_norm'
# Optionally adjust the percentages
split_data(data_folder, train_pct=0.9, val_pct=0.1, test_pct=0.0)
